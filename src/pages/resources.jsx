  ...
  return (
    <div className="pb-24"> {/* Space for floating button */}
      ...
      <div className="px-4 pt-4 pb-3 bg-[#111] sticky top-0 z-30 border-b border-[#2b2b2b]">
        <h1 className="text-2xl font-bold text-[hsl(0_0%_95%)] text-center">Ressources</h1>
      </div>
      ...
      {resources.length > 0 && (
        <div className="flex justify-center items-center gap-3 py-6">
          ...
          <span className="text-gray-400 font-medium min-w-[40px] text-center">Page {page}</span>
          <button
